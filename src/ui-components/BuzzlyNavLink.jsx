...
export default function BuzzlyNavLink(props) {
  ...
  return (
    <View
      ...
      {...getOverrideProps(overrides, "BuzzlyNavLink")}
      {...rest}
    >
      <Flex
        gap="209px"
      ...
      >
        <Heading
          ...
          {...getOverrideProps(overrides, "Heading38631933")}
        ></Heading>
        <Heading
          width="unset"
          height="unset"
          ...
          {...getOverrideProps(overrides, "Heading38631935")}
        ></Heading>
      </Flex>
      <View
        padding="0px 0px 0px 0px"
      ...
      >
        <Icon
          width="60.76px"
          height="60px"
          viewBox={{ minX: 0, minY: 0, width: 60.75927734375, height: 60 }}
          paths={[
            {
      ...
      <Text
        ...
        whiteSpace="pre-wrap"
        children="Buzzly"
        {...getOverrideProps(overrides, "Buzzly")}
      ></Text>
    </View>
  );
}
