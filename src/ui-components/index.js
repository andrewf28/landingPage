...
export { default as Client2x2 } from "./Client2x2";
...
export { default as ClientOrCreator } from "./ClientOrCreator";
export { default as ClientOrCreator1 } from "./ClientOrCreator1";
export { default as ClientOrCreator2 } from "./ClientOrCreator2";
export { default as ClientUpdateForm } from "./ClientUpdateForm";
export { default as CommentCard } from "./CommentCard";
export { default as ContactUs } from "./ContactUs";
export { default as Creator2x2 } from "./Creator2x2";
export { default as CreatorCreateForm } from "./CreatorCreateForm";
export { default as CreatorInfo1 } from "./CreatorInfo1";
...
export { default as PlsWork } from "./PlsWork";
